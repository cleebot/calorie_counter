...
export default function DietInfo() {
  return (
    <div>
      <h1>Why Track Your Meals?</h1>
      <h3>Many diet plans require you to keep track of certain nutritional values in order to make sure that you can achieve the goals that you set for yourself.
        Listed below are some details and resources for popular diet plans that people follow based on what they want to achieve!</h3>
      <p><b>Atkins Diet</b>: <br />
        The Atkins diet's main idea is to eat lots of protein while consuming very little carbohydrates. Studies have shown that the Atkins diet is good for weight loss and improvemnets in blood sugar and triglycerides.
